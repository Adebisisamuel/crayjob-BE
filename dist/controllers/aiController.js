...
exports.vapiCallback = exports.callCandidates = void 0;
...
const callCandidates = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const endpoint = process.env.VAPI_API_ENDPOINT;
        ...
        const assistant = {
            ...
            firstMessage: "Hello, How are you doing today? I am a recruiter and you have been headhunted for an amazing job and I would love to just ask a few questions in about 4 minutes. Is this a good time to talk?",
            clientMessages: [
                "transcript",
                "hang",
                "function-call",
        ...
        const callCustomer = (customer) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                const vapiResponse = yield axios_1.default.post(endpoint, {
                    phoneNumberId,
                    customer: {
...
const vapiCallback = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.vapiCallback = vapiCallback;
