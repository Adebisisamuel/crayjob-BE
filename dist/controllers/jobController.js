...
const createJob = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      res
        .status(500)
        .json((0, responseHandler_1.errorResponse)("Internal Server Error"));
      return;
    }
  });
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      if (!req.user) {
        res
          .status(401)
          .json((0, responseHandler_1.errorResponse)("Unauthorized"));
        return;
      }
...
const updateJob = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      res.json(
        (0, responseHandler_1.successResponse)("Job Updated Successfully", job)
      );
      return;
    } catch (error) {
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      res
        .status(200)
        .json(
          (0, responseHandler_1.successResponse)("Job Deleted Successfully")
        );
    } catch (error) {
